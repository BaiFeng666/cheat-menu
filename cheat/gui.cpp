...
void gui::CreateHWindow(const char* windowName) noexcept {
  ...
  // after WS_POPUP, 2 ints are window position when executed
  window = CreateWindowEx(0, "class001", windowName, WS_POPUP, 600, 340, WIDTH,
                          HEIGHT, 0, 0, windowClass.hInstance, 0);
